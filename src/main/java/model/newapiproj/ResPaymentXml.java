...
@XmlType(propOrder={"trxid", "trxdate", "partnerid", "productid", "customerid", "totalamount", "receiptcode", "additionaldata", "rc", "rcdesc", "trackingref", "terminalid", "signature"})
public class ResPaymentXml {
    @Size(max=20)
    @NotBlank
    ...
    @Size(max=20)
    @NotBlank
    @Pattern(regexp = "^[a-zA-Z0-9/]*$", message = "The value must be alphanumeric or “/”.")
