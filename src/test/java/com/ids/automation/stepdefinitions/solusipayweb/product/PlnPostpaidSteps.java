...
public class PlnPostpaidSteps {
    ...
    public void i_navigate_to_solusipayweb_pln_postpaid() {
        ...
        scenario.attach(screenshotData, "image/png", "Solusipay Web Page - Navigate to PLN Postpaid Page");
        solpayWebHelper.delay(1000);
    ...
    public void i_m_now_on_the_pln_post_page() {
        ...
        screenshotData = Helper.takeScreenshot(driver);
        scenario.attach(screenshotData, "image/png", "Solusipay Web Page - On PLN Postpaid Page");
    }

    @When("I input {string} Pln Post")
