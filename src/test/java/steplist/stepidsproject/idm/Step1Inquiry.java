...
import model.idsproject.idm.inquiry.ReqInquiry;
...
public class Step1Inquiry {
    ...
    public void valid_request_api_inquiry_ids_project(String storeId, String productId, String paymentCode) {
        ...
        ReqInquiry req = new ReqInquiry(productId, messageId, paymentCode, storeId, timeStamp, trackingRef);
        reqInq = req;
    ...
    public void partner_hit_api_inquiry_ids_project() {
        ...
        String reqSoapInq = soapHelp.buildIDSProjSoapRequestIDM(rowData, "getInquiry");
        ...
        if (!resSoapInq.isEmpty()) {
            ...
            try {
                ...
                JsonNode kReturn = rootNode.path("S:Envelope").path("S:Body").path("ns2:getInquiryResponse").path("return");
