...
Feature: Setorku Transaction
  ...
  Scenario Outline: [stg][SOB SetorKu] Get data partner transaction using Filter by Date -- "<condition>"
    Given I am in Menu "SetorKu" and Sub-Menu "Partner Transaction"
    * I click filter button on "SetorKu Partner Transaction"
    * I fill From Date ("05,07") and To Date ("05,08") on "SetorKu Partner Transaction"
  ...
  Scenario Outline: [stg][SOB SetorKu] Get data partner transaction using Filter by field --"<condition>"
    Given I am in Menu "SetorKu" and Sub-Menu "Partner Transaction"
    * I click filter button on "SetorKu Partner Transaction"
    * I fill From Date ("05,07") and To Date ("05,08") on "SetorKu Partner Transaction"
    * I choose "<partner>" partnerID on filter field
    * I click field "<label>" and fill with "<value>" on Setorku Partner Transaction
    ...
    Examples:
      ...
      | SOF     | User Name     | randomcase,SOF.SSS.MASAMBA.PALOPO | Failed    |
  ...
  Scenario Outline: [stg][SOB SetorKu] Get data transaction using Filter by all field -- "<condition>"
    Given I am in Menu "SetorKu" and Sub-Menu "Partner Transaction"
    * I click filter button on "SetorKu Partner Transaction"
    * I fill From Date ("05,07") and To Date ("05,08") on "SetorKu Partner Transaction"
    * I choose "<partner>" partnerID on filter field
    ...
    * I click field "Branch Name" and fill with "<branch>" on Setorku Partner Transaction
    ...
    Examples:
      ...
      | random,20 | SOF     | 50220240803178054001 | SOF.SSS.LEUWILIANG.BOGOR | 2024080312591450232 | BOGOR   | Failed   |
      | 413208567 | SOF     | random,64            | SOF.SSS.LEUWILIANG.BOGOR | 2024080312591450232 | BOGOR   | Failed   |
      | 413208567 | SOF     | 50220240803178054001 | random,50                | 2024080312591450232 | BOGOR   | Failed   |
      | 413208567 | SOF     | 50220240803178054001 | SOF.SSS.LEUWILIANG.BOGOR | random,20           | BOGOR   | Failed   |
      | 413208567 | SOF     | 50220240803178054001 | SOF.SSS.LEUWILIANG.BOGOR | 2024080312591450232 | CIREBON | Failed   |
      | 413208567 | SOF     | 50220240803178054001 | LEUWILIANG               | 2024080312591450232 | BOGOR   | Failed   |
